    ...
    */
    ...
    var Datepicker = function (element, options) {
        ...
        */
        ...
        this.update();
        if (this.inputField.val() && this.viewDate.getUTCFullYear() < 2400){
            this.inputField.val(this.viewDate.getDate().toString().padStart(2, "0")+"/"+(this.viewDate.getMonth()+1).toString().padStart(2, "0")+"/"+(this.viewDate.getUTCFullYear()+543));
        }
        if (this.isInline) {
            this.show();
        }
    ...
    Datepicker.prototype = {
        ...
        _trigger: function (event, altdate) {
            ...
            this.element.trigger({
                ...
                format: $.proxy(function (ix, format) {
                    ...
                    return DPGlobal.formatDate(date, format, this.o.language, this.o.thaiyear);
                }, this)
            });
        },
        ...
        getFormattedDate: function (format) {
            ...
            var thaiyear = this.o.thaiyear;
            return $.map(this.dates, function (d) {
                return DPGlobal.formatDate(d, format, lang, thaiyear);
        ...
        _fill_yearsView: function (selector, cssClass, factor, step, currentYear, startYear, endYear, callback) {
            ...
            */
            ...
            for (i = -1; i < 11; i += 1) {
                ...
                html += '<span class="' + classes.join(' ') + '"' + (tooltip ? ' title="' + tooltip + '"' : '') + ' data-ss="'+thisYear+'">' + (thisYear+543) + '</span>';
                thisYear += step;
            }
        ...
        fill: function () {
            ...
            this.picker.find('.datepicker-days .datepicker-switch')
						.text(DPGlobal.formatDate(d, titleFormat, this.o.language, this.o.thaiyear));
    ...
    var DPGlobal = {
        ...
        formatDate: function (date, format, language, thaiyear) {
            if (!date)
                return '';
            if(thaiyear == true && date.getUTCFullYear() < 2560)
                yearOffSet = 543;
            else
                yearOffSet = 0;
            if (typeof format === 'string')
