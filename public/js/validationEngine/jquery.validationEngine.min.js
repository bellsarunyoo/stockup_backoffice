    ...
    var F = {
        ...
        attach: function (e) {
            ...
            return (
                ((t = e
                    ? F._saveOptions(a, e)
                    : a.data("jqv")).validateAttribute = a.find(
                ...
                r
                    ...
                    .each(function () {
                        ...
                        o.prettySelect &&
                            e.is(":hidden") &&
                            (e = r.find(
                                "#" + o.usePrefix + e.attr("id") + o.useSuffix
                            ));
        ...
        _validateFields: function (a) {
            ...
            if (
                ...
                if (r.scroll) {
                    ...
                    if (
                        (r.scrollOffset && (e -= r.scrollOffset), r.isOverflown)
                    ) {
                        ...
                        for (var t = !1, a = 0; a < e.length; a++) {
                            ...
                            if (1 == o.length) {
                                ...
                                if (1 == r[1])
                                    ...
                                    var n;
                                    if (((t |= !0), d.allrules[s]))
                                        (n = d.allrules[s].alertText) &&
                                            (s = n);
                                    d.showPrompts &&
                                        F._showPrompt(o, s, "", !1, d, !0);
                                }
                            }
                        }
        ...
        _validateField: function (e, t, a) {
            if (
                ...
                return !1;
            if (
                !t.validateNonVisibleFields &&
                ((e.is(":hidden") && !t.prettySelect) ||
                    e.parent().is(":hidden"))
            )
                return !1;
            ...
            for (
                var f = T(e.closest("form, .validationEngineContainer")), v = 0;
                v < s.length;
                v++
            )
                (s[v] = s[v].toString().replace(" ", "")),
                    "" === s[v] && delete s[v];
            v = 0;
                ...
                switch (s[v]) {
                    ...
                    case "groupRequired":
                        var h =
                            ...
                            x = f.find(h).eq(0);
                        x[0] != e[0] &&
                            (F._validateField(x, t, a), (t.showArrow = !0)),
                            (g = F._getErrorMessage(
                                f,
                                e,
                                s[v],
                    ...
                    case "dateRange":
                        ...
                        (t.firstOfGroup = f.find(h).eq(0)),
                            ...
                            (t.firstOfGroup[0].value ||
                                t.secondOfGroup[0].value) &&
                                (g = F._getErrorMessage(
                                    f,
                                    e,
                                    s[v],
            ...
            return (
                ...
                t.isError && t.onFieldFailure && t.onFieldFailure(e),
                !t.isError && t.onFieldSuccess && t.onFieldSuccess(e),
                t.isError
            );
        },
        ...
        _getCustomErrorMessage: function (e, t, a, r) {
            var i = !1,
                o = /^custom\[.*\]$/.test(a)
                    ...
                    : F._validityProp[a];
            if (null != o && null != (i = e.attr("data-errormessage-" + o)))
                return i;
            ...
            switch (e.prop("type")) {
                ...
                case "checkbox":
                    ...
                    if (0 == o.find("input[name='" + s + "']:checked").length)
                        return 1 ==
                            o.find("input[name='" + s + "']:visible").length
        ...
        _ajax: function (s, e, t, n) {
            ...
            if (
                ("field" == n.eventTrigger &&
                    delete n.ajaxValidCache[s.attr("id")],
                !n.isError && !F._checkAjaxFieldStatus(s.attr("id"), n))
            )
                return (
                    T.ajax({
                                ...
                                if (r) {
                                    ...
                                    n.showPrompts &&
                                        (i
                                            ...
                                            : F._closePrompt(a)),
                                        "submit" == n.eventTrigger &&
                                            s.closest("form").submit();
                                } else {
                                    var o;
                                    if (
                                        ((n.ajaxValidCache[t] = !1),
                                        (n.isError = !0),
                                        i)
                                    ) {
                                        if (n.allrules[i])
                                            (o = n.allrules[i].alertText) &&
                                                (i = o);
                                    } else i = l.alertText;
                                    n.showPrompts &&
                                        F._showPrompt(a, i, "", !0, n);
                                }
                            }
        ...
        _updatePrompt: function (e, t, a, r, i, o, s) {
            if (t) {
                void 0 !== r &&
                    ("pass" == r
                        ? t.addClass("greenPopup")
                        : t.removeClass("greenPopup"),
                    "load" == r
                        ? t.addClass("blackPopup")
                        : t.removeClass("blackPopup")),
